...
export const regions: Region[] = [
  ...
  {
    name: 'Trans-Euphrates (Beyond the River)',
    speakAs: 'Trans-YOU-fray-teez',
    description: "The Persian administrative province covering the territory west of the Euphrates River including Syria, Phoenicia, Judah, and Samaria; Ezra's authorization from Artaxerxes was addressed to all the officials of Trans-Euphrates; Nehemiah was appointed governor of Judah within this satrapy (Ezra 4:10–16; 5:3; 7:21; Nehemiah 2:7–9)",
    color: '#8e44ad',
    fillOpacity: 0.15,
    location: 'confirmed',
    books: ['Ezra', 'Nehemiah'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        // Trans-Euphrates — west of Euphrates to Mediterranean
        [36.00, 37.50],
        [38.50, 37.00],
        [38.50, 34.00],
        [37.00, 32.00],
  ...
  {
    name: 'Province of Judah (Persian Era)',
    speakAs: 'Province of Judah',
    description: "The small Persian administrative unit centered on Jerusalem; much reduced from the ancient kingdom of Judah; Nehemiah was its governor; the returnees from Babylon settled here and rebuilt the Temple and walls; surrounded by hostile neighbors — Samaria, Ammon, Ashdod, and Arabia (Ezra 1:3; Nehemiah 2:7; 5:14)",
    color: '#7d3c98',
    fillOpacity: 0.22,
    location: 'confirmed',
    books: ['Ezra', 'Nehemiah'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        // Persian-era Judah — smaller than the old kingdom
        [34.75, 32.05],
        [35.22, 31.90],
        [35.50, 31.75],
        [35.40, 31.15],
  ...
  {
    name: 'Province of Samaria (Persian Era)',
    speakAs: 'Province of Samaria',
    description: "The Persian province north of Judah governed by Sanballat the Horonite; Sanballat was Nehemiah's principal opponent and repeatedly tried to obstruct the wall-building — mocking, threatening military attack, and attempting to trap Nehemiah through false prophecy and correspondence (Nehemiah 2:10, 19; 4:1–8; 6:1–14)",
    color: '#c0392b',
    fillOpacity: 0.16,
    location: 'confirmed',
    books: ['Nehemiah'],
  ...
  {
    name: 'Province of Ammon (Persian Era)',
    speakAs: 'Province of Ammon',
    description: "The territory east of the Jordan governed by Tobiah the Ammonite; he was closely allied with Sanballat and together they harassed and threatened the builders of Jerusalem's wall; Tobiah had connections inside Jerusalem through marriage, and the priest Eliashib even gave him a room in the Temple courts which Nehemiah threw out (Nehemiah 2:10; 4:3; 6:17–19; 13:4–9)",
    color: '#d35400',
    fillOpacity: 0.18,
    location: 'confirmed',
    books: ['Nehemiah'],
  ...
  {
    name: 'Media',
    description: "The ancient empire north and east of Persia; Cyrus's decree was found in the archives at Ecbatana (Achmetha), the Median capital; the Medes and Persians together formed the empire that replaced Babylon (Ezra 6:2; Daniel 5:28)",
    color: '#2874a6',
    fillOpacity: 0.18,
    location: 'confirmed',
    books: ['Ezra', 'Daniel', 'Isaiah'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        [44.00, 38.50],
  ...
  {
    name: 'Persian Empire (Esther Era)',
    speakAs: 'Persian Empire',
    description: "The empire of Ahasuerus (Xerxes) stretching from India to Cush — 127 provinces; the setting of the entire book of Esther; the king's decrees went out to every province in its own script and language; the Jewish people lived scattered throughout these provinces (Esther 1:1; 3:12–14; 8:9)",
    color: '#1a5276',
    fillOpacity: 0.12,
    location: 'confirmed',
    books: ['Esther'],
  ...
  },
  {
    name: 'India (Hodu)',
    speakAs: 'HOH-doo',
    description: "The eastern boundary of the Persian Empire as described in Esther; 'from India (Hodu) to Ethiopia, 127 provinces'; Hodu corresponds to the Indus Valley region known to the Persians as Hindush, the easternmost satrapy (Esther 1:1; 8:9)",
    color: '#e67e22',
    fillOpacity: 0.18,
    location: 'confirmed',
    books: ['Esther'],
...

  {
    name: 'Land of Uz',
    speakAs: 'OOZZ',
    description: "The homeland of Job — 'a man in the land of Uz, blameless and upright'; the precise location is disputed but generally placed in the regions east of Canaan — possibly northern Arabia, Edom, or the Syrian desert; Jeremiah links Uz with Edom (Job 1:1; Jeremiah 25:20; Lamentations 4:21)",
    color: '#b8860b',
    fillOpacity: 0.22,
    location: 'unknown',
    books: ['Job'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        // East of Canaan / Edom region — broadly northern Arabia
        [36.00, 32.50],
        [38.50, 32.50],
        [39.50, 31.00],
        [38.50, 29.00],
  ...
  {
    name: 'Land of the East (Job)',
    description: "'His possessions were the greatest of all the people of the East' — the East (Qedem) in Job refers to the vast desert steppe east of the Jordan and Canaan; the homeland of nomadic peoples, the Sabeans and Chaldeans who raided Job's flocks (Job 1:3; Judges 6:3; Genesis 25:6)",
    color: '#e8c165',
    fillOpacity: 0.18,
    location: 'probable',
    books: ['Job'],
  ...
  },
  {
    name: 'Teman',
    speakAs: 'TEE-man',
    description: "The region of southern Edom renowned for its wisdom; Eliphaz the Temanite was Job's first friend and principal theological opponent; 'Is there no longer wisdom in Teman? Has counsel perished from the prudent?' — Teman's wisdom tradition was proverbial in the ancient world (Job 2:11; 4:1; Jeremiah 49:7; Obadiah 1:8–9)",
    color: '#7b241c',
    fillOpacity: 0.25,
    location: 'probable',
    books: ['Job', 'Jeremiah', 'Amos', 'Obadiah'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        [35.10, 30.80],
  ...
  },
  {
    name: 'Shuah',
    speakAs: 'SHOO-ah',
    description: "The homeland of Bildad the Shuhite, Job's second friend; Shuah is identified as a son of Abraham by Keturah and likely refers to a tribal territory along the middle Euphrates or in northern Arabia; Bildad argued that God punishes the wicked and rewards the righteous (Job 2:11; 8:1; Genesis 25:2)",
    color: '#8e6b00',
    fillOpacity: 0.22,
    location: 'probable',
    books: ['Job', 'Genesis'],
  ...
  },
  {
    name: 'Naamah',
    speakAs: 'NAY-ah-mah',
    description: "The homeland of Zophar the Naamathite, Job's third friend; the location of Naamah is uncertain — candidates include a town in Judah (Joshua 15:41), a place in northern Arabia, or a region in Edom; Zophar was the most blunt of the three friends (Job 2:11; 11:1)",
    color: '#5b8c5a',
    fillOpacity: 0.20,
    location: 'unknown',
    books: ['Job'],
    geometry: {
      type: 'Polygon',
      coordinates: [[
        // Tentatively placed in the Edom/Negev area
        [35.00, 31.00],
        [35.50, 31.00],
        [35.60, 30.50],
        [35.30, 30.20],
